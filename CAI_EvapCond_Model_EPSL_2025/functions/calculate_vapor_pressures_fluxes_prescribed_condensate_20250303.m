function [ n_sat_vector, mu_sat_vector, V_output, rxnRates, ...
    evaporationFluxes_all, productionFluxes, P_envelope] = ...
...
z1 = particleArea * (R*T/(2*pi))^(1/2) / (volume_gss*1e-5);    % a scalar         %%%%%% volume used here should be m3 (hence: volume_gss*1e-5, where 1e-5 is conversion to m^3) !!!!!!!!!!!!!!!!!!!
